...
#variables
from variables_from_config import HABITAT_VELOCITY_THRESHOLDS, DRIFT_THRESHOLDS_NO_RAMP, DRIFT_THRESHOLDS_WITH_RAMP, DESICCATION_THRESHOLDS, HABITAT_TARGETS, CRS, DEPTH_THRESHOLD
...
from habitat_attribution import prepare_csv, attribute_habitat_current_based
...
# cropping the shapefile: to the corresponding known discharges from the flow time series; and keeping only the wetted mask (meshed wet fot the max considered discharge)
...
# ------------------------------------------------------------------------------------------------------------------
# exporting the cropped shapefile to a csv 
